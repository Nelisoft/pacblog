...
SECRET_KEY = 'django-insecure-edpvzjewxx8o(g4br(v57^y#9w$j33j6)q+bsy_9_i0c!#pt7d'
...
# Static files (optional - you can keep them local/whitenoise)
...
CKEDITOR_5_FILE_STORAGE = "django.core.files.storage.FileSystemStorage"  # optional (or use your custom storage)
...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {"name": "Visit_Site",  "url": "Home", "permissions": ["auth.view_user"]},
...
CLOUDINARY_STORAGE = {
'CLOUD_NAME': 'dqvtt0van',
    'API_KEY': '922814287632368',
    'API_SECRET': 'yEnV16CJa7-zsB5pRQMZoh4oRF4'
}
# DEFAULT_FILE_STORAGE = 'cloudinary_storage.storage.MediaCloudinaryStorage'
STORAGES = {
    "default": {
